    ...
    public class VideoRepository : BaseRepository, IVideoRepository
    {
        ...
        public List<Video> GetAll()
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                        SELECT v.Id, v.Title, v.Description, v.Url, v.DateCreated, v.UserProfileId, up.Name, up.Email, up.DateCreated AS UserProfileDateCreated, up.ImageUrl AS UserProfileImageUrl
                        FROM Video v
        ...
        public List<Video> GetAllWithComments()
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                        SELECT v.Id AS VideoId, v.Title, v.Description, v.Url, v.DateCreated AS VideoDateCreated, v.UserProfileId As VideoUserProfileId, up.Name, up.Email, up.DateCreated AS UserProfileDateCreated, up.ImageUrl AS UserProfileImageUrl, c.Id AS CommentId, c.Message, c.UserProfileId AS CommentUserProfileId
                        FROM Video v
                        JOIN UserProfile up ON v.UserProfileId = up.Id
        ...
        public Video GetById(int id)
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                        SELECT v.Title, v.Description, v.Url, v.DateCreated AS VideoDateCreated, v.UserProfileId,
                            up.[Name], up.Email, up.ImageUrl, up.DateCreated AS UserDateCreated
                        FROM Video v
